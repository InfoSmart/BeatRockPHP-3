...
class Core
{
	...
	// @@Obsoleta - Planeada para retirarse en la versión 2.4.3
	// Por favor use la función "strip_tags" de PHP.
	...
	// Función - Obtener el motor del navegador web del Agente web.
	// - $agent: Agente web.
	...
	// Función - Obtener el "Mime Type" de un archivo.
