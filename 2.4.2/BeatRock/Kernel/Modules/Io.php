...
class Io
{
	...
	public static function Write($file, $data)
	{
		...
		$r = file_put_contents($file, $data) or self::Error('11i', 'No se ha podido escribir el contenido dentro del archivo de salida.', __FUNCTION__, $file);;			
	...
	{
		$r = unlink($file) or self::Error('11i', 'No se ha podido eliminar el archivo.', __FUNCTION__, $file);
	...
	public static function Copy($file, $to, $params = Array())
	{
		...
		if($r == false)
			self::Error('11i', 'No se ha podido copiar el archivo.', __FUNCTION__, $file);
	...
	{
		$r = rename($file, $to) or self::Error('11i', 'No se ha podido mover/renombrar el archivo.', __FUNCTION__, $file);
	...
	public static function EmptyDir($dir, $del = false)
	{
		if(is_array($dir))
		{
			foreach($dir as $d)
