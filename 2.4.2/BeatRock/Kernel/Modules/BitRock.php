...
class BitRock
{
	...
	public function __construct()
	{
		if(!version_compare(PHP_VERSION, '5.3.0', '>='))
			exit('BeatRock no soporta esta versión de PHP (' . phpversion() . '). Por favor actualiza tu plataforma de PHP a la 5.4.X o superior.');
	...
	public static function Statistics()
	{
		...
		$return .= 'Se cargaron ' . count(self::$modules) . ' módulos durante la sesión actual.<br />';
