...
/*if($P['server_limit_load'] < 0 OR $P['server_limit_load'] > 100 OR !is_numeric($P['server_limit_load']))
	$error[] = "Selecciona un limite de carga de CPU válido.";*/
	
if($P['logs_save'] == 'error' OR $P['logs_save'] == 'warning' OR $P['logs_save'] == 'info' OR $P['logs_save'] == 'onerror')
	$P['logs_save'] = "'$P[logs_save]'";	
