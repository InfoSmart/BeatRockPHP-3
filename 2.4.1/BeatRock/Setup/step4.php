...
<div class="content">
	...
	<form action="./step4?do=save" method="POST">
		...
		<section>
			...
			<p>
				<br />
				<b>¡Atención!</b> Por ahora Facebook desconoce algunas ubicaciones como <b>"es_MX"</b> que al estar configuradas en tu aplicación ocacionan que "Open Graph" no funcione correctamente, al publicar tu aplicación utiliza la <a href="https://developers.facebook.com/tools/debug" target="_blank">herramienta "debugger"</a> para verificar si tu ubicación es "aceptada". Si no es así utiliza ubicaciones más conocidas como <b>es_ES</b> o <b>en_US</b>. 
				<br />
			</p>
